...
export const TIMELINE_EVENTS: Record<string, TimelineEvent[]> = {
  ...
  'DN-2026-0412': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-17, 9, 30), actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Sarah Chen', detail: 'Assigned during morning queue review.' },
  ...
  'DN-2026-0278': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-11, 8, 15), actor: 'System', actorType: 'system', summary: 'Assigned to Marcus Webb', detail: 'Auto-assigned per Medicare ADR rotation schedule.' },
    { id: 'e5', type: 'action_records_requested', timestamp: ts(-11, 9, 0), actor: 'Marcus Webb', actorType: 'provider', summary: 'Records request sent to HealthSource', detail: 'ADR metadata and request ID submitted to HealthSource ROI. Expected retrieval: 5–7 business days.', document: 'HEALTHSOURCE_REQUEST_HS-2026-0412.pdf' },
  ...
  'DN-2026-0377': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-9, 10, 0), actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Priya Nair', detail: 'Assigned to UHC authorization specialist.' },
  ...
  'DN-2026-0305': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-21, 9, 0), actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Devon Ross', detail: 'Assigned for clearinghouse proof of timely filing research.' },
  ...
  'DN-2026-0401': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-7, 8, 30), actor: 'System', actorType: 'system', summary: 'Assigned to Marcus Webb', detail: 'Auto-assigned per Medicare coding rotation.' },
  ],
  'DN-2026-0358': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-4, 9, 0), actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Sarah Chen', detail: '' },
  ],
  'DN-2026-0344': [
    ...
    { id: 'e5', type: 'action_assign', timestamp: ts(-5, 9, 0), actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Devon Ross', detail: '' },
  ],
  'DN-2026-0331': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-13, 9, 0), actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Marcus Webb', detail: 'Self-assigned — Marcus leads BCBS recoupment disputes.' },
    { id: 'e5', type: 'action_records_requested', timestamp: ts(-12, 10, 0), actor: 'Marcus Webb', actorType: 'provider', summary: 'Clinical documentation pull initiated', detail: 'Requested complete medical record from HIM for DOS 1/30/2026 admission.' },
  ],
  'DN-2026-0318': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-3, 9, 30), actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Priya Nair', detail: '' },
  ],
  'DN-2026-0292': [
  ...
  'DN-2026-0261': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: ts(-1, 9, 0), actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Devon Ross', detail: '' },
  ],
  ...
  'DN-2025-0847': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-07-29T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Sarah Chen', detail: 'Assigned during morning queue review.' },
  ...
  'DN-2025-1201': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-09-13T09:30:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Priya Nair', detail: 'Assigned to UHC medical necessity specialist.' },
  ...
  'DN-2025-0932': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-07-02T08:15:00.000Z', actor: 'System', actorType: 'system', summary: 'Assigned to Marcus Webb', detail: 'Auto-assigned per Medicare ADR rotation.' },
    { id: 'e5', type: 'action_records_requested', timestamp: '2025-07-02T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Records request sent to HealthSource', detail: 'ADR metadata submitted to HealthSource ROI. Records retrieved and submitted to Medicare within deadline.', document: 'HealthSource_Request_HS-2025-0114.pdf' },
    { id: 'e6', type: 'action_records_submitted', timestamp: '2025-07-18T14:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Medical records submitted to Medicare', detail: 'Full clinical record transmitted to Medicare via esMD. Submission tracking #MCR-ESMD-2025-0718-003.' },
    ...
    { id: 'e8', type: 'action_note', timestamp: '2025-08-20T13:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Case escalated to DRG dispute', detail: 'ADR response completed. Medicare issued DRG downgrade as a result of records review. New denial DN-2025-0933 created for dispute workflow. This ADR case closed.' },
  ],
  ...
  'DN-2025-0933': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-08-21T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Marcus Webb (continuity from ADR)', detail: 'Self-assigned — maintains continuity with ADR case.' },
    { id: 'e5', type: 'action_note', timestamp: '2025-08-25T10:30:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Clinical review — MCC dispute identified', detail: 'CDI review confirms J18.9 (pneumonia) coded as secondary diagnosis IS a valid MCC under CMS grouper rules. MCC coding was correct. Drafting appeal.' },
    { id: 'e6', type: 'action_appeal_l1', timestamp: '2025-09-05T14:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Level 1 appeal submitted to Medicare', detail: 'Submitted via esMD with coding attestation, attending letter, and CMS grouper documentation supporting MCC classification.', document: 'L1_Appeal_CLM9862004.pdf' },
    ...
    { id: 'e8', type: 'action_appeal_l2', timestamp: '2025-10-10T11:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Level 2 QIC appeal submitted', detail: 'Full record and augmented coding analysis submitted to QIC. Highlighted CMS IOM guidance on J18.9 MCC classification.', document: 'L2_QIC_Appeal_CLM9862004.pdf' },
  ...
  'DN-2025-1089': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-10-23T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Priya Nair', detail: 'Assigned to Cigna authorization specialist.' },
  ...
  'DN-2025-1156': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-11-09T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Sarah Chen', detail: '' },
  ...
  'DN-2025-0788': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-08-19T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Marcus Webb', detail: 'Self-assigned — Medicare recoupment specialist.' },
    { id: 'e5', type: 'action_records_requested', timestamp: '2025-08-20T10:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Clinical documentation pull initiated', detail: 'Full medical record requested from HIM for DOS 8/10/2025 admission for dispute package.' },
    ...
    { id: 'e7', type: 'action_note', timestamp: '2025-10-15T11:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Settlement offer received from Medicare', detail: 'Medicare offered partial settlement: $6,200 repayment in lieu of full $12,400. Finance and legal reviewed — accepted as favorable given litigation risk.' },
  ...
  'DN-2025-1302': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-07-16T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Devon Ross', detail: 'Assigned to timely filing research specialist.' },
  ...
  'DN-2026-0044': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2025-12-02T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Marcus Webb', detail: '' },
    { id: 'e5', type: 'action_note', timestamp: '2025-12-10T10:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'CDI review completed — sequencing corrected', detail: 'CDI confirmed E11.65 (Type 2 DM with hyperglycemia) should be secondary to I50.9 (Heart failure). Corrected claim prepared.' },
    { id: 'e6', type: 'action_resubmit', timestamp: '2025-12-15T14:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Corrected claim submitted via clearinghouse', detail: 'Corrected claim submitted to BCBS via Change Healthcare clearinghouse. 277-CA acknowledgment received.', document: 'Corrected_Claim_CLM7700009.txt' },
  ...
  'DN-2026-0077': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2026-01-09T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Devon Ross', detail: '' },
  ...
  'DN-2026-0103': [
    ...
    { id: 'e4', type: 'action_assign', timestamp: '2026-01-16T09:00:00.000Z', actor: 'Marcus Webb', actorType: 'provider', summary: 'Assigned to Sarah Chen', detail: '' },
...
export const CLAIM_DATA_837: Record<string, Claim837Data> = {
  ...
  // ── DN-2026-0451: Medicare RAC — Marcus Webb (Intake) ─────────────────────
  'DN-2026-0451': {
